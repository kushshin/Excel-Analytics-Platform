...
function Footer() {
 ...
 <footer id="contact"className="w-[500px] sm:w-full md:w-full lg:w-full footer sm:footer-horizontal bg-blue-100 text-base-content pr-10 pb-10 pt-10 pl-40 mt-0  ">
  <nav>
